...
def criar_histograma_acertos(resultados, nome_aluno, limite_max):
    ...
    if limite_max < 100:
        ...
        resultados_filtrados = resultados[resultados['Fez questão'] > limite_max*30/60]
        ...
        fig.add_vline(
            ...
            annotation=dict(
                font=dict(color='blue', size=12),  # aqui resolve
                yshift=0
            )
        )
        ...
        fig.add_vline(
            ...
            annotation_position="top",
            annotation=dict(
                font=dict(color='red', size=12),  # aqui resolve
                yshift=15
            )
        )
        ...
        #    annotation=dict(
        #        font=dict(color='green', size=12),  # aqui resolve
        #        yshift=30
        #    )
        #)
        ...
        #    annotation_position="top",  # Posição da anotação
        #    annotation=dict(
        #        font=dict(color='orange', size=12),  # aqui resolve
        #        yshift=45
        #    )
        #)
...
def mostrar_resultados_simulados(nome, permissao, email, turma):
    ...
    alunos_sn = ler_planilha("1bH9GCzYnlrjSJcThkcW933pYV-rgzgPr7Tz-015iLuw", "Simulado Nacional!A1:E")
    ...
    if permissao != 'Inscrito Simulado Nacional':
        ...
        if (turma == 'Semiextensivo Presencial' or turma == 'Semiextensivo Online' or turma_aluno == 'Semiextensivo Presencial' or turma_aluno == 'Semiextensivo Online'):
            ...
            simulados = ["Escolha o simulado"] + ['Simulado Insper 01'] + ['Simulado FGV 01'] + ['Simulado Insper 02'] + ['Simulado FGV 02'] + ['Simulado Insper 03'] + ['Simulado FGV 03'] + ['Simulado Insper 04'] + ['Simulado FGV 04'] + ['Simulado Nacional Insper']+ ['Simulado Nacional FGV'] + ['Simulado Insper 06'] + ['Simulado FGV 06'] + ['Simulado FGV 07'] #+ ['Simulado FGV 01'] + ['Simulado FGV 02'] + ['Simulado FGV 03'] + ['Simulado FGV 04'] + ['Simulado FGV 05'] + ['Simulado FGV 06']
            ...
            simulados = ["Escolha o simulado"] + ['Simulado Insper 01'] + ['Simulado FGV 01'] + ['Simulado Insper 02'] + ['Simulado FGV 02'] + ['Simulado Nacional Insper'] + ['Simulado Nacional FGV'] +['Simulado Insper 04'] + ['Simulado FGV 04'] + ['Simulado Insper 05'] + ['Simulado FGV 05']# + ['Simulado 02'] + ['Simulado 03'] + ['Simulado 04'] + ['Simulado Nacional Insper'] + ['Simulado Nacional FGV'] + ['Simulado 05'] + ['Simulado 06'] + ['Simulado 07']
        ...
        if resultados_gerais_aluno1['Acerto'].sum() > 0:
            ...
            if "Insper" in simulado_selecionado:
                ...
                if simulado_selecionado != 'Simulado Nacional Insper':
                    ...
                    resultados_gerais5_60 = resultados_gerais5[resultados_gerais5['Fez questão'] > 30]
            ...
            if (simulado_selecionado[:15] == 'Simulado Insper' or simulado_selecionado[:12] == 'Simulado FGV' or simulado_selecionado[:17] == 'Simulado Nacional'):
                ...
                if len(redacao_tabela3['Status']) != 0:
                    ...
                    if simulado_selecionado == 'Simulado Nacional Insper':
                        ...
                        criar_histograma_acertos(resultados_gerais_redacao, nome_aluno3, 100)
